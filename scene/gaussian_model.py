...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int):
        ...
        self._target_features_dc = torch.empty(0)
        self._target_features_rest = torch.empty(0)
    ...
    def get_features(self):
        # features_dc = (torch.sigmoid(self._features_dc) - 0.5) / 0.28209479177387814
    ...
    def get_t_features(self):
        features_dc = self._target_features_dc
        features_rest = self._target_features_rest
        return torch.cat((features_dc, features_rest), dim=1)
    ...
    def set_target(self, target_features):
        self._target_features_dc = target_features[:, :1]
        self._target_features_rest = target_features[:, 1:]
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_t_features_dc=None, new_t_features_rest=None):
        d = {"xyz": new_xyz,
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacity, new_scaling, new_rotation, new_t_features_dc, new_t_features_rest)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_t_features_dc, new_t_features_rest)
